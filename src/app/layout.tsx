...
export default function RootLayout({
  ...
  return (
    <html lang="de" suppressHydrationWarning>
      <body className={cn("min-h-screen bg-gray-50 dark:bg-gray-900", inter.className)}>
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
          enableSystem
        ...
        >
          <div className="flex flex-col min-h-screen">
            {/* Header */}
            <header className="border-b bg-white dark:bg-gray-950 dark:border-gray-800 fixed top-0 left-0 right-0 z-50">
              <div className="container max-w-[1200px] mx-auto h-16 px-4">
                <div className="flex items-center justify-between h-full">
                  {/* Left side */}
                  <div className="flex items-center gap-8">
                    <Link href="/" className="flex items-center gap-2 font-medium dark:text-white">
              ...
              <div 
                className={cn(
                  "md:hidden bg-white dark:bg-gray-950 border-b dark:border-gray-800 overflow-hidden transition-all duration-300",
